        ...
        try {
            ...
            { 
                ...
                if ($offer_type == "" || $offer_type == "promocode") {
                    loyaltyhelper::savepoints($vdata,$user_id,$order_number,1,'');
                } else {
                    if ($offer_type == "loyalty") {
                        loyaltyhelper::savepoints($vdata,$user_id,$order_number,2,$couponcode);
                    }
                }
