...
class PaymentController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            if(in_array($data->payment_name,['RazorPay','Stripe','Flutterwave','Paystack','Mercadopago','PayPal','MyFatoorah','toyyibpay'])){
            ...
            if($data->payment_name == 'flutterwave'){
            ...
            if($data->payment_name == 'Banktransfer' && Auth::user()->type == 1){
