                    ...
                    <div class="card box-shadow border-0 h-100 text-dark plancard">
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <small
                                    class="text-muted line-limit-3">{{ Str::limit($plandata->description, 150) }}</small>
                            </div>
                            <hr>
                            <ul>
                        ...
                        <div
                            class="card-footer bg-white border-top-0 my-2 text-center d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    @else
                                        <a onclick="statusupdate('{{ URL::to('admin/plan/delete-' . $plandata->id) }}')"
                                            tooltip="{{ trans('labels.delete') }}" class="btn btn-sm btn-danger btn-size">
                            ...
                            @else
                                ...
                                @else
                                    ...
                                    @elseif ((float) Auth::user()->purchase_amount > $plandata->price)
                                        <small
                                            class="text-danger d-block fw-500 text-start">{{ trans('labels.already_used') }}</small>
                                    @else
                                        <div class="d-flex justify-content-end w-100">
                                            <a href="{{ URL::to('admin/plan/selectplan-' . $plandata->id) }}"
                                                class="btn btn-sm bg-success text-white rounded-5 px-3 d-block">{{ trans('labels.subscribe') }}</a>
