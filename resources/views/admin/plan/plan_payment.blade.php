                ...
                <div class="card-body">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-text bg-transparent border-0 p-0">
                                                    <input class="form-check-input mt-0" type="radio"
                                                        ...
                                                        @if ($payment_type == 'banktransfer') data-bank-name="{{ $pmdata->bank_name }}" data-account-holder-name="{{ $pmdata->account_holder_name }}" data-account-number="{{ $pmdata->account_number }}" data-bank-ifsc-code="{{ $pmdata->bank_ifsc_code }}" @endif
                                                        name="paymentmode">
                                                </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button
                            ...
                            class="btn btn-success btn-succes m-1 {{ env('Environment') == 'sendbox' ? '' : 'buy_now' }} ">
