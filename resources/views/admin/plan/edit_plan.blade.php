                                        ...
                                        <div class="col-sm-6 mt-2">
                                            <div class="form-group">
                                                <input class="form-check-input" type="checkbox" name="social_logins"
                                                    @if ($editplan->social_logins == '1') checked @endif id="social_logins">
                                                <label class="form-check-label"
                                                    for="social_logins">{{ trans('labels.social_login') }}</label>
                                            </div>
                                            @error('social_logins')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                            <label for="template1" class="radio-card position-relative">
                                                <input type="checkbox" name="themecheckbox[]" id="template1"
                                                    value="1" {{ in_array(1, $themes) ? 'checked' : '' }}>
                                        ...
                                        @if (App\Models\SystemAddons::where('unique_identifier', 'template')->first() != null &&
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template2" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template2"
                                                        value="2" {{ in_array(2, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template3" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template3"
                                                        value="3" {{ in_array(3, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template4" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template4"
                                                        value="4" {{ in_array(4, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template5" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template5"
                                                        value="5" {{ in_array(5, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template6" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template6"
                                                        value="6" {{ in_array(6, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                                            <img src="{{ helper::image_path('theme-6.png') }}">
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template7" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template7"
                                                        value="7" {{ in_array(7, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                                            <img src="{{ helper::image_path('theme-7.png') }}">
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template8" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template8"
                                                        value="8" {{ in_array(8, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                                            <img src="{{ helper::image_path('theme-8.png') }}">
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template9" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template9"
                                                        value="9" {{ in_array(9, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                                            <img src="{{ helper::image_path('theme-9.png') }}">
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 pt-0 mt-0">
                                                <label for="template10" class="radio-card position-relative">
                                                    <input type="checkbox" name="themecheckbox[]" id="template10"
                                                        value="10" {{ in_array(10, $themes) ? 'checked' : '' }}>
                                                    <div class="card-content-wrapper border rounded-2">
                                                        <span class="check-icon position-absolute"></span>
                                                        <div class="selecimg">
                                                            <img src="{{ helper::image_path('theme-10.png') }}">
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
