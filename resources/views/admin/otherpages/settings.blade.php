                        ...
                        <ul class="d-flex align-items-center flex-md-wrap general_settings list-options gap-2 mb-3">
                                ...
                                @if (App\Models\SystemAddons::where('unique_identifier', 'subscription')->first() != null &&
                                    ...
                                    @if (App\Models\SystemAddons::where('unique_identifier', 'pwa')->first() != null &&
                                        ...
                                        @php
                                            ...
                                            if (helper::vendordata(Auth::user()->id)->allow_without_subscription == 1) {
                                                $pwa = 1;
                                            } else {
                                                $pwa = @$checkplan->pwa;
                                            }
                            ...
                            @if (Auth::user()->type == 1)
                                ...
                                @if (App\Models\SystemAddons::where('unique_identifier', 'google_analytics')->first() != null &&
                                    ...
                                    <li>
                                        <a data_attribute="google_analytics"
                                            class="list-group-item basicinfo p-2 px-3 list-item-secondary d-flex justify-content-between align-items-baseline"
                                            aria-current="true">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            class="d-flex justify-content-start mt-2 mt-md-0 justify-content-md-center {{ env('Environment') == 'sendbox' ? 'col-md-3 ' : 'col-md-3' }}">
                                                            <div>
                                                                <label class="form-label"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <span
                                                                class="input-group-text rounded-start-3">{{ URL::to('/') }}</span>
                                                            <input type="text" class="form-control mb-0"
                                                                id="slug" name="slug"
                                                                value="{{ Auth::user()->slug }}" required>
                                                        </div>
                                                        @error('slug')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                            ...
                                            <div class="form-group">
                                                <div class="row justify-content-between align-items-center mb-2">
                                                    ...
                                                    @if (count($getfooterfeatures) > 0)
                                                        <span class="col-auto"><button class="btn-add border-0"
                                                                type="button"
                                                ...
                                                <div class="row mb-2">
                                                    @forelse ($getfooterfeatures as $key => $features)
                                                        ...
                                                        <div class="col-md-1 form-group">
                                                            <button class="btn btn-danger btn-sm rounded-5 pricebtn"
                                                                type="button"
                                                    ...
                                                    @empty
                                                        ...
                                                        <div class="col-md-1 form-group">
                                                            <button class="btn btn-info btn-sm rounded-5 pricebtn"
                                                                type="button"
                                                                onclick="add_features('{{ trans('labels.icon') }}','{{ trans('labels.title') }}','{{ trans('labels.description') }}')">
                                        ...
                                        <div class="row">
                                            @if (Auth::user()->type == 2)
                                                <div class="form-group col-sm-6 mt-2">
                                                    ...
                                                    @enderror
                                                    <img class="img-fluid rounded-3 hw-70 mb-2 object-fit-cover"
                                                ...
                                                <div class="form-group col-sm-6 mt-2">
                                                    ...
                                                    @error('subscribe_background')
                                                        <small class="text-danger">{{ $message }}</small> <br>
                                                    @enderror
                                                    <img class="img-fluid rounded-3 hw-70 mb-2"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                @error('logo')
                                                                    ...
                                                                    <br>
                                                                @enderror
                                                                <img class="img-fluid rounded-3 hw-70 mb-2 object-fit-contain"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="row g-2">
                                                                <div class="col-auto">
                                                                    <div id="bg-selector" tooltip="Custom"
                                                                        class="position-relative">
                                                                        <div class="color picker form-control-color"
                                                                            onclick="pickColor();">
                                                                            <img
                                                                                src="{{ url(env('ASSETSPATHURL') . 'images/color.png') }}">
                                                                        </div>
                                                                        <input id="colorpicker" class="piker-position"
                                                                            type="color"
                                                                            value="{{ @$settingdata->primary_color }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button primary_color"
                                                                        onclick="primary_color_update('#1D5B79')">
                                                                        <span
                                                                            class="p_color1 {{ @$settingdata->primary_color == '#1D5B79' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button primary_color"
                                                                        onclick="primary_color_update('#181D31')">
                                                                        <span
                                                                            class="p_color2 {{ @$settingdata->primary_color == '#181D31' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button primary_color"
                                                                        onclick="primary_color_update('#643843')">
                                                                        <span
                                                                            class="p_color3 {{ @$settingdata->primary_color == '#643843' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button primary_color"
                                                                        onclick="primary_color_update('#064635')">
                                                                        <span
                                                                            class="p_color4 {{ @$settingdata->primary_color == '#064635' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <input type="hidden" id="secondary_color" name="secondary_color"
                                                            ...
                                                            <div class="row g-2">
                                                                <div class="col-auto">
                                                                    <div id="bg-selector" tooltip="Custom"
                                                                        ...
                                                                        <input id="colorpicker2" class="piker-position"
                                                                            type="color"
                                                                            value="{{ @$settingdata->secondary_color }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button secondary_color"
                                                                        onclick="secondary_color_update('#468B97')">
                                                                        <span
                                                                            class="s_color1  {{ @$settingdata->secondary_color == '#468B97' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button secondary_color"
                                                                        onclick="secondary_color_update('#6096B4')">
                                                                        <span
                                                                            class="s_color2  {{ @$settingdata->secondary_color == '#6096B4' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button secondary_color"
                                                                        onclick="secondary_color_update('#99627A')">
                                                                        <span
                                                                            class="s_color3  {{ @$settingdata->secondary_color == '#99627A' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                                                        class="piker-button secondary_color"
                                                                        onclick="secondary_color_update('#519259')">
                                                                        <span
                                                                            class="s_color4  {{ @$settingdata->secondary_color == '#519259' ? 'spanactive' : '' }}"></span>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-12 col-md-4 col-lg-4 col-xl-3">
                                                                    <label for="template{{ $item }}"
                                                                        ...
                                                                        <div class="card-content-wrapper border rounded-2">
                                                                            <span
                                                                                class="check-icon position-absolute"></span>
                                                                            <div class="selecimg">
                                                                                <img
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <label for="template_type_1"
                                                                    ...
                                                                    <div class="card-content-wrapper border rounded-2">
                                                                        <span
                                                                            class="check-icon position-absolute m-2"></span>
                                                                        <div class="selecimg">
                                    ...
                                    <form method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                @enderror
                                                <img class="img-fluid rounded-3 hw-70 object-fit-cover mb-2"
                                    ...
                                    <div class="card-body">
                                        <form action="{{ URL::to('/admin/landingsettings') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" name="landing_primary_color"
                                                    id="primary_color_admin"
                                                    value="{{ @$settingdata->primary_color }}" />
                                                    ...
                                                    <div class="row g-2 mb-2">
                                                        <div class="col-auto">
                                                            <div id="bg-selector" tooltip="Custom"
                                                                class="position-relative">
                                                                <div class="color picker form-control-color"
                                                                    onclick="pickColor_admin();">
                                                                    <img
                                                                        src="{{ url(env('ASSETSPATHURL') . 'images/color.png') }}" />
                                                                </div>
                                                                <input id="colorpicker_landing" class="piker-position"
                                                                    type="color"
                                                                    value="{{ @$settingdata->primary_color }}" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button primary_color"
                                                                onclick="primary_color_update1('#1D5B79')">
                                                                <span
                                                                    class="p1_color1 {{ @$settingdata->primary_color == '#1D5B79' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>

                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button primary_color"
                                                                onclick="primary_color_update1('#181D31')">
                                                                <span
                                                                    class="p1_color2 {{ @$settingdata->primary_color == '#181D31' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button primary_color"
                                                                onclick="primary_color_update1('#643843')">
                                                                <span
                                                                    class="p1_color3 {{ @$settingdata->primary_color == '#643843' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button primary_color"
                                                                onclick="primary_color_update1('#064635')">
                                                                <span
                                                                    class="p1_color4 {{ @$settingdata->primary_color == '#064635' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="landing_secondary_color"
                                                    id="secondary_color_admin"
                                                    value="{{ @$settingdata->secondary_color }}" />
                                                <div class="form-group col-sm-6">
                                                    <label
                                                    ...
                                                    <div class="row g-2 mb-2">
                                                        <div class="col-auto">
                                                            <div id="bg-selector" tooltip="Custom"
                                                                class="position-relative">
                                                                <div class="color picker form-control-color"
                                                                    onclick="pickColor2_admin();">
                                                                    <img
                                                                        src="{{ url(env('ASSETSPATHURL') . 'images/color.png') }}" />
                                                                </div>
                                                                <input id="colorpicker2_landing" class="piker-position"
                                                                    type="color"
                                                                    value="{{ @$settingdata->secondary_color }}" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button secondary_color"
                                                                onclick="secondary_color_update1('#468B97')">
                                                                <span
                                                                    class="s1_color1  {{ @$settingdata->secondary_color == '#468B97' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>

                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button secondary_color"
                                                                onclick="secondary_color_update1('#6096B4')">
                                                                <span
                                                                    class="s1_color2  {{ @$settingdata->secondary_color == '#6096B4' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button secondary_color"
                                                                onclick="secondary_color_update1('#99627A')">
                                                                <span
                                                                    class="s1_color3  {{ @$settingdata->secondary_color == '#99627A' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button type="button" class="piker-button secondary_color"
                                                                onclick="secondary_color_update1('#519259')">
                                                                <span
                                                                    class="s1_color4  {{ @$settingdata->secondary_color == '#519259' ? 'spanactive' : '' }}"></span>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="text-end">
                                                <button
                                                    ...
                                                    class="btn btn-success btn-succes mt-3">{{ trans('labels.save') }}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
