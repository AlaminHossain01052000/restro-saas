                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-end border-0" colspan="4">
                                    <strong class="fw-600">@if ($getorderdata->offer_type == "loyalty") Loyalty Discount @endif @if ($getorderdata->offer_type == "promocode") {{ trans('labels.discount') }} {{ $getorderdata->couponcode != '' ? '(' . $getorderdata->couponcode . ')' : '' }} @endif</strong>
                                </td>
                                <td class="text-end border-0">
