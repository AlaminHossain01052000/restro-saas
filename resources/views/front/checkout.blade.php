                    ...
                    <div class="card border-0 select-delivery rounded-4">
                        <div class="card-body px-sm-3 px-2">
                            ...
                            <div class="row mt-2 align-items-center">
                                <p class="apply-coupon-subtitle col-10" id="loyalty_desc">{{ trans('labels.you_have_currently') }} <b>{{ @loyaltyhelper::availablepoints(@Auth::user()->id,$storeinfo->id) }}</b> {{ trans('labels.use_it_on_order') }}</p>
                                <div class="px-2 py-2">
                                    <h5>1 {{ trans('labels.point') }} = {{ helper::currency_formate(@loyaltyhelper::getloyaltydata(@$storeinfo->id)->per_coin_amount, @$storeinfo->id) }}</h5>

                                    @if(loyaltyhelper::availablepoints(@Auth::user()->id,$storeinfo->id) > 0)
                                    <div class="d-flex mt-2 gap-2" >
                                        <input type="text" class="form-control input-h" name="points" id="points" placeholder="{{ trans('labels.enter_point') }}" value="{{Session::get('offer_code')}}" 
                                        ...
                                        <div id="points_button">
                                            ...
                                            @else
                                                <button class="btn-primary btn" onclick="RedeemPoints('{{$storeinfo->id}}')">{{ trans('labels.redeem') }}</button>
                                            @endif
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="col">
                                ...
                                <ul class="list-group list-group-flush order-summary-list" id="payment_summery_list">
                                    ...
                                    <li class="list-group-item" id="discount_1">
                                        @if (Session::get('offer_type') == "loyalty") Loyalty Discount @else {{ trans('labels.discount') }} @endif (-)
                                        <span>
