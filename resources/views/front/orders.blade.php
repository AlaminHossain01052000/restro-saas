                            ...
                            <div class="card border-1 rounded-3 px-sm-3 px-0">
                                <div class="card-body">
                                    <div class="d-flex flex-wrap justify-content-between mb-2">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            <span class="fs-7 fw-400 text-muted">{{ helper::date_format($orderdata->created_at) }}</span>
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <div class="d-flex gap-2 flex-wrap justify-content-between mt-2">
                                        <div class="d-flex align-items-center">
                                            <span>
                                                ...
                                                <span class="text-white badge text-bg-warning fs-8 fw-400 rounded-5 px-3 py-1 ">
                                                    {{ trans('labels.placed') }}
                                                </span>
                                                @elseif($orderdata->status == '2')
                                                <span class="text-white badge text-bg-info fs-8 fw-400 rounded-5 px-3 py-1 ">
                                                    {{ trans('labels.preparing') }}</span>
                                                @elseif($orderdata->status == '3')
                                                <span class="text-white badge text-bg-danger fs-8 fw-400 rounded-5 px-3 py-1 ">
                                                    {{ trans('labels.cancelled_by_you') }}</span>
                                                @elseif($orderdata->status == '4')
                                                <span class="text-white btn badge text-bg-danger fs-8 fw-400 rounded-5 px-3 py-1 ">
                                                    {{ trans('labels.cancelled_by_user') }}</span>
                                                @elseif($orderdata->status == '5')
                                                <span class="text-white badge text-bg-success fs-8 fw-400 rounded-5 px-3 py-1 ">
