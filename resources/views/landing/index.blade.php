                    ...
                    <div class="col-md-6 col-12">
                        <div class="banner-content me-xl-5 me-lg-3 me-md-2">
                            ...
                            <div class="input-group mb-lg-4 mb-3">
                                <a href="{{ URL::to('/admin') }}" class="btn btn-secondary rounded h-45"
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12 mb-4 mb-md-0">
                                <div class="card h-100 border-0 rounded-0 pb-xl-5">
                                    ...
                                    <div class="card-footer border-0 bg-transparent">
                                        <a href="{{ URL::to('/admin') }}" class="border-bottom ms-4 fw-500 ms-lg-0 ms-xl-4"
                ...
                <div class="container">
                    ...
                    <div class="templates-owl owl-carousel owl-theme text-white">
                        <div class="item h-100 temp-active">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/01.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/02.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/03.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/04.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100 temp-active">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/05.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/06.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/07.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/08.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/09.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="{{ url(env('ASSETSPATHURL') . 'landing/images/png/10.webp') }}" alt=""
                                class="object-fit-cover h-100">
                        </div>
                    </div>
                    <!-- theme-preview-content -->
